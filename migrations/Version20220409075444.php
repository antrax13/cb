 ...
 */
final class Version20220409075444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD shipping_info LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote DROP shipping_info');
    }
}
