...
class ProductReferenceAdminController extends AbstractController
{
     ...
     */
    public function uploadProductReference(CustomProductInfo $productInfo, Request $request, UploaderHelper $uploaderHelper, EntityManagerInterface $entityManager, ValidatorInterface $validator)
    {
